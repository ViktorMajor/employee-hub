...
export class EmployeeService {
  private employees: Employee[] = [
    {
      ...
      jobTitle: "Advisor",
      description:
        "Bill Gates is the co-founder of Microsoft, the world's largest PC software company. He is known for his philanthropic efforts through the Bill & Melinda Gates Foundation.",
    },
    {
      id: 2,
      name: "Mary Kay Ash",
      ...
      jobTitle: "Chairman",
      description:
        "Mary Kay Ash founded Mary Kay Cosmetics, a company that has empowered millions of women worldwide. She's recognized for her innovative business strategies and empowering leadership style.",
    },
    {
      id: 3,
      name: "Dave Ulrich",
      ...
      jobTitle: "HR Advisor",
      description:
        "Dave Ulrich is a renowned figure in the HR world, known for his research and publications. He has significantly influenced HR practices and leadership globally.",
    },
    {
      id: 4,
      name: "Warren Buffet",
      ...
      jobTitle: "Director",
      description:
        "Warren Buffet, the 'Oracle of Omaha', is one of the most successful investors of all time. He's the chairman and largest shareholder of Berkshire Hathaway.",
    },
    {
      id: 5,
      name: "Philip Kotler",
      ...
      description:
        "Philip Kotler is often referred to as the 'Father of Modern Marketing'. His books and teachings have shaped modern marketing education and practices.",
    },
    {
      id: 6,
      name: "Indra Nooyi",
      ...
      homeOffice: "No",
      education: "Master's in Public and Private Management",
      jobTitle: "Advisor",
      description:
        "Indra Nooyi is the former CEO of PepsiCo and has consistently ranked among the world's 100 most powerful women. She's known for her visionary leadership and strategic acumen.",
    },
    {
      id: 7,
      ...
      jobTitle: "Engineer",
      description:
        "Sheryl Sandberg is the COO of Facebook and founder of LeanIn.Org. She's an advocate for women in leadership and has authored several influential books.",
    },

    {
      ...
      description:
        "Ruth Porat is the CFO of Alphabet Inc. (Google's parent company). She's recognized for her expertise in finance and her leadership in the tech industry.",
    },
    {
      id: 9,
      ...
      jobTitle: "Marketing Advisor",
      description:
        "Angela Ahrendts is the former Senior Vice President of Apple Inc. She's known for her leadership at Burberry and her role in Apple's retail strategy.",
    },
    {
      id: 10,
      name: "Anne Mulcahy",
      ...
      jobTitle: "Manager",
      description:
        "Anne Mulcahy is the former CEO and Chairwoman of Xerox Corporation. She's credited with turning Xerox around during a critical period.",
    },
    {
      id: 11,
      name: "Steve Jobs",
      ...
      jobTitle: "Director",
      description:
        "Steve Jobs was the co-founder of Apple Inc. His vision and innovation have revolutionized multiple industries from computers and animated movies to music, phones, and tablet computing.",
    },
    {
      id: 12,
      name: "Elon Musk",
      ...
      jobTitle: "Advisor",
      description:
        "Elon Musk is the CEO of Tesla and SpaceX. He's a visionary entrepreneur known for his ambitious goals of sustainable energy and interplanetary colonization.",
    },
    {
      id: 13,
      ...
      jobTitle: "Advisor",
      description:
        "Mark Zuckerberg is the co-founder and CEO of Facebook. He has played a pivotal role in shaping the social media landscape.",
    },
    {
      id: 14,
      name: "Sundar Pichai",
      ...
      homeOffice: "Yes",
      education:
        "Indian Institute of Technology Kharagpur, Stanford University, Wharton School of the University of Pennsylvania",
      jobTitle: "Advisor",
      description:
        "Sundar Pichai is the CEO of Google and its parent company, Alphabet Inc. He's known for his calm demeanor and leadership in the tech industry.",
    },
    {
      id: 15,
      name: "Satya Nadella",
      ...
      homeOffice: "Yes",
      education:
        "Manipal Institute of Technology, University of Wisconsin–Milwaukee",
      jobTitle: "Advisor",
      description:
        "Satya Nadella is the CEO of Microsoft. Under his leadership, Microsoft has seen a resurgence, focusing on cloud computing and innovation.",
    },
  ];
  ...
  groupByDepartment(employees: Employee[]): {
  ...
  getFilteredEmployeesArray(
    ...
    for (let department of Object.keys(groupedEmployees)) {
      result = result.concat(
        groupedEmployees[department].filter((employee) =>
